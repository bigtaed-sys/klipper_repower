...
Краткое описание и быстрый старт — в [README_RU.md](README_RU.md). Здесь
собрано всё детальное: установщик, команды, параметры, проба Z, линия
прочистки, уведомления, диалоги и принцип работы.
